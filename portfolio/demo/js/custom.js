...
$(document).on('ready', function() {
    ...
    /*=========================================================================
     Language ring animation with Waypoint JS
     =========================================================================*/
    if ($('.language-card').length > 0) {
      var langWaypoint = new Waypoint({
        element: document.querySelector('.language-card'),
        handler: function () {
          $('.language-card').addClass('in-view');
          $('.lang-fill').each(function () {
